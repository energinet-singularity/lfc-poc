...
import sys
import os
from functions_kafka import (init_producer, init_consumer, init_topic_partitions, produce_message, subscribe_topics,
                             topics_exists, get_latest_topic_messages_to_dict_poll_based, list_empty_topics)
...
# Kafka consumer
consumer_kafka = init_consumer(bootstrap_servers=kafka_host,
...
if not topics_exists(consumer=consumer_kafka, topic_list=topics_list):
    sys.exit(1)
